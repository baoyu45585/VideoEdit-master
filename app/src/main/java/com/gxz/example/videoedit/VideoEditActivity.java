...
public class VideoEditActivity extends AppCompatActivity {
    ...
    private void initData() {
        path = "/storage/emulated/0/DCIM/cc.MP4";
        //for video check
    ...
    private void initEditVideo() {
        ...
        Log.e("=====","=="+(seekBar.getThumbWidth()));
        videoEditAdapter = new VideoEditAdapter(this,
                (UIUtil.getScreenWidth(this) - UIUtil.dip2px(this, 70)-2*seekBar.getThumbWidth()) / MAX_COUNT_RANGE);
        mRecyclerView.addItemDecoration(new EditSpacingItemDecoration(UIUtil.dip2px(this, 35)+seekBar.getThumbWidth(), thumbnailsCount));
        mRecyclerView.setAdapter(videoEditAdapter);
        mRecyclerView.addOnScrollListener(mOnScrollListener);
        if (endPosition <= MAX_CUT_DURATION) {
            rangeWidth = mMaxWidth-2*seekBar.getThumbWidth();
        } else {
            rangeWidth = (mMaxWidth-2*seekBar.getThumbWidth()) / MAX_COUNT_RANGE * thumbnailsCount;
        }
        ...
        int extractW = (UIUtil.getScreenWidth(this) - UIUtil.dip2px(this, 70)-2*seekBar.getThumbWidth()) / MAX_COUNT_RANGE;
        ...
        averagePxMs = ((mMaxWidth-2*seekBar.getThumbWidth()) * 1.0f / (rightProgress - leftProgress));
...
//                videoStart();
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (scrollX == -UIUtil.dip2px(VideoEditActivity.this, 35)-seekBar.getThumbWidth()) {
                scrollPos = 0;
            } else {
                ...
                isSeeking = true;
                scrollPos = (long) (averageMsPx * ((UIUtil.dip2px(VideoEditActivity.this, 35)+seekBar.getThumbWidth()) + scrollX));
    ...
    private void anim() {
        ...
        int start = (int) (UIUtil.dip2px(this, 35) +seekBar.getThumbWidth()+ (leftProgress/*mVideoView.getCurrentPosition()*/ - scrollPos) * averagePxMs);
        int end = (int) (UIUtil.dip2px(this, 35)+seekBar.getThumbWidth()+ (rightProgress - scrollPos) * averagePxMs);
